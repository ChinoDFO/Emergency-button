...
Para crear un grupo en la app no necesitas inicio de sesión, simplemente presiona el botón con el ícono '+', asignas nombre a tu grupo y presionas la opción "suscribir".
...
'+' y colocar el nombre del grupo que creaste; Por último seleccionar la opción "suscribir".
...
2.-Entra a tus ajustes de WiFi y verás una red llamada "ALARMA CONFIG". Conectate a esa red y de forma automática se abrirá el portal de configuración de red. Si no se abre automáticamente, entra a tu navegador y escribe la siguiente IP: 192.168.4.1

3.-En el portal seleccionarás la opción: "Configurar WiFi" (o algo similar).

4.-Después de seleccionar, verás una lista de redes WiFi disponibles. Busca tu red WiFi y seleccionala, después, introduce la contraseña de tu red.
...
Estos serán los datos que llegarán en las notificaciones a las personas suscritas a tu grupo.

6.-De forma opcional puedes agregar una red de respaldo (preferiblemente la del hotspot de tu celular) esto en caso de que no haya internet o se haya ido la luz.

7.-Presiona la opción "Guardar" y espera a que el led verde encienda y el rojo apague.

***¡¡¡NOTAS IMPORTANTES!!!***

  -Para conectar a la red de tu celular, simplemente tienes que activar la opción llamada "hotspot", es decir, tienes que
  compartir datos.
  
  -Si fue el caso de que se fue la luz o solo internet, y regresa, por seguridad, asegúrate que haya regresado por completo antes
  de desactivar el hotspot, es decir, antes de dejar de compartir datos.
